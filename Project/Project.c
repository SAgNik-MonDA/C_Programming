...
int round1()
{
    ...
    scanf("%d", &deposit1);
    printf("\n\n");
    printf("Your currennt balance is $ :-%d", deposit1);
    printf("\n\n");
    ...
    if (guess1 == computer1)
    {
        ...
        printf("You have won $ %d is  total", new_won);
    }
    else if (guess1 != computer1)
    {
        ...
        else
        {
            ...
            if (decision == 1)
            {
                ...
                printf("\n\n");
                int bet3;
                printf("%s, Enter the moneyy to bet :$", name);
                scanf("%d", &bet3);
                printf("\n\n");
                if (bet3 > new_los)
                {
                ...
                else if (guess2 != computer2)
                {
                    ...
                    printf("\n\n");
                    if (b2==0){
                        printf(" Sir  you havee $0 as a balance \n");
...
int rules(){
    ...
    printf("RULES\n");
    printf(".................................\n");
    printf("1. choose any number netween 1 to 10\n");
    printf("2. If you win you will get 10 times of money  you bet \n");
    printf("3..If you bet on wrong number ypu will lose  your beeting amount  \n");
    printf("..................................................................\n");
}